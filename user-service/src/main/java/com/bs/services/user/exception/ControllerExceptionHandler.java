...
import com.bs.services.user.dto.response.ApiErrorResponse;
...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<Object> handleRelationExistsException(
      final ValidationFailureException ex,
      final WebRequest request
  ) {
    log.info(ex.getClass().getName());
    log.error("Error Log", ex);
    final ApiErrorResponse apiError = new ApiErrorResponse(HttpStatus.PRECONDITION_FAILED,
        HttpStatus.PRECONDITION_FAILED.value(), ex.getMessage(), ex.getMessage());
